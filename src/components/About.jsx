    ...
    <div className={`py-20 px-4 sm:px-6 lg:px-8 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className={`text-3xl font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-900'}`}>About Me</h2>
        ...
        <div className="md:flex items-center">
          ...
          <div className="md:w-2/3">
            <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
              I'm <span className={`${darkMode ? 'text-blue-400' : 'text-blue-600'}`}>Emman</span>, an IT Student Developer
            </h3>
            ...
            <div className={`border-l-2 border-blue-600 pl-4 space-y-6 ${darkMode ? 'border-blue-500' : ''}`}>
              <div>
                <div className="flex items-center">
                  ...
                  <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>BS Information Technology</h4>
                </div>
              ...
              <div>
                <div className="flex items-center">
                  ...
                  <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Self-taught Web Development</h4>
                </div>
              ...
              <div>
                <div className="flex items-center">
                  ...
                  <h4 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Mobile App Development</h4>
                </div>
                <p className={darkMode ? 'text-gray-400 text-sm' : 'text-gray-500 text-sm'}>Ongoing</p>
